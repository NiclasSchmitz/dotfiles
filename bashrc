...
if test -f "$FZF_KEY_BINDINGS"; then
    source $FZF_KEY_BINDINGS
fi

# enable fuzzy auto-completion
FZF_COMPLETION=/usr/share/doc/fzf/examples/completion.bash
if test -f "$FZF_COMPLETION"; then
    source $FZF_COMPLETION
fi

# Extend PATH with folder for user defined scripts
